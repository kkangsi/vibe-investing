...
3. **국내 백테스트는 아직 없다.** 원본의 38.75% CAGR·−16.9% MDD는 **미국 종목 2024–2026 백테스트** 수치입니다. 본 대시보드는 *동일한 룰을 국내 종목에 적용* 한 것일 뿐, **한국 시장에서 검증된 성과가 아닙니다.** 합성/사후편향 한계는 원문의 "한계 및 위험" 절을 참고하세요.
